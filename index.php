...
Description: This is a to become a suite of tools that takes care of non-sense dirty work on fresh WordPress installs.
...
if ($wpptOptionsArray['hideBar']==1) {$hideBar=1;}

if ($wpptOptionsArray['hideBarAdmin']==1) {$hideBarAdmin=1;}

if(trim($outputMessage)<>""){$outputMessage.="<br /><br /><span class=\"bold\">Note: You may need to reload to see the bar in the back end</span>";}
  ...
  <div class="wpptNotice"><h2>Why this is called "Power Tools" ??</h2>
